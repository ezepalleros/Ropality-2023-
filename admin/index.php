...
<div class="container text-center">
    <h1 class="text-primary mt-4">Panel de administrador de Ropality</h1>
...
while ($filas = mysqli_fetch_array($resultado)) {
    print "
        <tr>
            <td>{$filas['nombreCategoria']}</td>
            <td><a href='productos.php?nombreCategoria={$filas['idCategoria']}' class='btn btn-info btn-sm'>Ver Productos</a></td>
            <td><a href='modCat.php?nombreCategoria={$filas['idCategoria']}' class='btn btn-warning btn-sm'>Modificar</a></td>
            <td><a href='borrCat.php?nombreCategoria={$filas['idCategoria']}' class='btn btn-danger btn-sm'>Eliminar</a></td>
        </tr>";
}
